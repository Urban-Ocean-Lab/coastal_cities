...
urban.df <- read.csv(file = "urban_pop.csv", header = TRUE, sep = ",") %>%
  ...
  mutate(NAME = as.character(NAME),
         ...
         row_num = row_number()) %>%
  select(NAME, "2018_pop" = S0101_C01_001E, "male_pop" = S0101_C03_001E, "female_pop" = S0101_C05_001E, 
         row_num)
...
##Calculate the total population living in coastal Urbanized Areas or Urban Clusters. This comes out to 
